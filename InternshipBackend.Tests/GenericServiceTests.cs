...
namespace InternshipBackend.Tests
{
    public class GenericServiceTests
    {
        ...
        private async Task<TestContext> CreateApplication(Action<WebApplicationBuilder>? configure = null)
        {
            ...
            return new TestContext(context, application, user, changeCurrentUser);
        }
